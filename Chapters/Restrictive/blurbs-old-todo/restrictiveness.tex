\begin{definition}[Restrictive functor]\label[definition]{c66}
...
\begin{definition}[Restrictive morphism]\label[definition]{c6f}
...
\begin{example}\label[example]{c74}
...
\begin{example}\label[example]{c79}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{c7f}
...
\begin{example}[Affine non-restrictive map]\label[example]{c8c}
