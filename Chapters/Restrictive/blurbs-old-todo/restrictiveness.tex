\begin{definition}[Restrictive functor]\label[definition]{c54}
...
\begin{definition}[Restrictive morphism]\label[definition]{c5d}
...
\begin{example}\label[example]{c62}
...
\begin{example}\label[example]{c67}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{c6d}
...
\begin{example}[Affine non-restrictive map]\label[example]{c7a}
