\begin{definition}[Restrictive functor]\label[definition]{c52}
...
\begin{definition}[Restrictive morphism]\label[definition]{c5b}
...
\begin{example}\label[example]{c60}
...
\begin{example}\label[example]{c65}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{c6b}
...
\begin{example}[Affine non-restrictive map]\label[example]{c78}
