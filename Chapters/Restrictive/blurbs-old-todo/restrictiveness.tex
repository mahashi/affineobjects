\begin{definition}[Restrictive functor]\label[definition]{cda}
...
\begin{definition}[Restrictive morphism]\label[definition]{ce3}
...
\begin{example}\label[example]{ce8}
...
\begin{example}\label[example]{ced}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{cf3}
...
\begin{example}[Affine non-restrictive map]\label[example]{d00}
