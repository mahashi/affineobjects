\begin{definition}[Restrictive functor]\label[definition]{cc5}
...
\begin{definition}[Restrictive morphism]\label[definition]{cce}
...
\begin{example}\label[example]{cd3}
...
\begin{example}\label[example]{cd8}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{cde}
...
\begin{example}[Affine non-restrictive map]\label[example]{ceb}
...
\begin{example}\label[example]{cf2}
