\begin{definition}[Restrictive functor]\label[definition]{cc8}
...
\begin{definition}[Restrictive morphism]\label[definition]{cd1}
...
\begin{example}\label[example]{cd6}
...
\begin{example}\label[example]{cdb}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{ce1}
...
\begin{example}[Affine non-restrictive map]\label[example]{cee}
