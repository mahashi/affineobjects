\begin{definition}[Restrictive functor]\label[definition]{ebf}
...
\begin{definition}[Restrictive morphism]\label[definition]{ec8}
...
\begin{example}\label[example]{ecd}
...
\begin{example}\label[example]{ed2}
...
\begin{lemma}[Restrictive to affines]\label[lemma]{ed8}
...
\begin{example}[Affine non-restrictive map]\label[example]{ee5}
