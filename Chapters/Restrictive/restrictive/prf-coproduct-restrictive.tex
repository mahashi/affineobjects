\begin{lemma}[coproduct]\label[lemma]{da7}
...
$\Leftarrow$:
By \Cref{d57}, the canonical morphism $X_i \rightarrow X_1 \disjointunion X_2$ is restrictive.
By assumption $X_1 \disjointunion X_2 \rightarrow Y$ is restrictive.
Composing these morphisms yields $f_i$, by \Cref{d77} this yields a restrictive morphism.
\end{proof}
