\begin{lemma}[coproduct]\label[lemma]{d13}
...
$\Leftarrow$:
By \Cref{cd6}, the canonical morphism $X_i \rightarrow X_1 \disjointunion X_2$ is restrictive.
By assumption $X_1 \disjointunion X_2 \rightarrow Y$ is restrictive.
Composing these morphisms yields $f_i$, by \Cref{cf6} this yields a restrictive morphism.
\end{proof}