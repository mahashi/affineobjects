\begin{lemma}[coproduct]\label[lemma]{d96}
...
$\Leftarrow$:
By \Cref{d46}, the canonical morphism $X_i \rightarrow X_1 \disjointunion X_2$ is restrictive.
By assumption $X_1 \disjointunion X_2 \rightarrow Y$ is restrictive.
Composing these morphisms yields $f_i$, by \Cref{d66} this morphism is restrictive.
\end{proof}
