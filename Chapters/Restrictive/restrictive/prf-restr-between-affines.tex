...
By \Cref{7c8}, we get $\sheaf{G} = \stilde{M}$.
As said in \Cref{da4}, in this case $\widehat{f} = \omega^2_{\Spec{S}}$.
By \Cref{83d}, we know that $\omega^2$ is an isomorphism at affine schemes.
\end{proof}