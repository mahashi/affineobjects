...
By \Cref{7ce}, we get $\sheaf{G} = \stilde{M}$.
As said in \Cref{db1}, in this case $\widehat{f} = \omega^2_{\Spec{S}}$.
By \Cref{842}, we know that $\omega^2$ is an isomorphism at affine schemes.
\end{proof}