...
By \Cref{a73}, we get $\sheaf{G} = \stilde{M}$.
As said in \Cref{f09}, in this case $\widehat{f} = \omega^2_{\Spec{S}}$.
By \Cref{d53}, we know that $\omega^2$ is an isomorphism at affine schemes.
\end{proof}