...
By \Cref{80f}, we get $\sheaf{G} = \stilde{M}$.
As said in \Cref{da6}, in this case $\widehat{f} = \omega^2_{\Spec{S}}$.
By \Cref{884}, we know that $\omega^2$ is an isomorphism at affine schemes.
\end{proof}