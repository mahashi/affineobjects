...
\begin{corollary}[\url{http://stacks.math.columbia.edu/tag/077K}]

Let $X$ be 'affine'. Then $\Qcoh{X}$ is a Grothendieck abelian category.
\end{corollary}

\begin{remark}[\url{http://stacks.math.columbia.edu/tag/077K}]
...
\begin{definition}[Right Adjoint/coherator]
...
\begin{lemma}[\url{http://stacks.math.columbia.edu/tag/015Z}]
