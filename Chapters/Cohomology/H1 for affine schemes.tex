...
\begin{lemma}
A ring homomorphism $R\rightarrow S$ is faithfully flat \iff it is flat and $S\tensor M=0 \Rightarrow M=0$.
\end{lemma}
\begin{proof}
Let our map be faithfully flat and $S\tensor M=0$. Then $0\rightarrow S\tensor M\rightarrow 0$ is exact. 
...
Let $S=\prod_i R_{f_i}$, this is a faithfully flat $R$-algebra.
...
We will use that $S$ is faithfully flat and prove exactness of 
...
Only used that any cover can be refined to a faithfully flat cover.
\end{document}