...
\begin{definition}\label[definition]{86}
...
\begin{definition}\label[definition]{97}
...
\begin{definition}\label[definition]{a7}
...
\begin{definition}\label[definition]{cd}
