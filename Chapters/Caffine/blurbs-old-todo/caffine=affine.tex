...
\begin{comment}
\begin{definition}\label[definition]{23c}
Define $G(\Ip)$ to be the generic point of $V_X(\Ip)$.
\end{definition}
\begin{lemma}\label[lemma]{23f}
