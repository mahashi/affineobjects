...
\begin{remark}\label[remark]{33e}
The only if direction always holds.
\end{remark}



\begin{lemma}[P1 holds with enough affines]\label[lemma]{344}
...
\begin{lemma}[Finite poset has enough affines]\label[lemma]{34c}
...
\begin{lemma}[Non-quasi-coherent sheaf]\label[lemma]{354}
...
\begin{example}[Stacks 01BL example]\label[example]{35c}
...
\begin{example}[Category without enough affines \#1]\label[example]{364}
%TODO
\end{example}

\begin{example}[General P1 does not hold]\label[example]{368}
