...
\begin{remark}\label[remark]{33a}
The only if direction always holds.
\end{remark}



\begin{lemma}[P1 holds with enough affines]\label[lemma]{340}
...
\begin{lemma}[Finite poset has enough affines]\label[lemma]{348}
...
\begin{lemma}[Non-quasi-coherent sheaf]\label[lemma]{350}
...
\begin{example}[Stacks 01BL example]\label[example]{358}
\input{../examples/stacks-01BL}
\end{example}

\begin{example}[Category without enough affines \#1]\label[example]{35c}
\input{../examples/Ny}
\end{example}

\begin{example}[Category without enough affines \#1]\label[example]{360}
%TODO
\end{example}

\begin{example}[General P1 does not hold]\label[example]{364}
