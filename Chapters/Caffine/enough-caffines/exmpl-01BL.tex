\begin{example}\label[example]{477}
This is the example in \cite[\href{http://stacks.math.columbia.edu/tag/01BL}{Tag 01BL}]{stacks}. We state it here because we will categorify it to yield a category that has not enough affines.
...
%Domain&codomain are associated sheaves
