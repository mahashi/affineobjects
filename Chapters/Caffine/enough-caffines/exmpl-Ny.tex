\begin{example}\label[example]{4e0}
This is will be a categorification of \Cref{477}.
This will yield us a category where $\stilde$ is not full over any object, so has no caffines.
%%% Example moved to N(y) setting
Let $X,f_j$ and $U_n$ be as in \Cref{477}. Set $y=0$ and consider the ringed site $N(y)$.
...
Observe that $\alpha$, and its restrictions, is a morphism between quasi-coherent sheaves but does not come from a map of modules by the previous contradiction.
