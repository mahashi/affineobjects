\begin{lemma}\label[lemma]{a24}
Let $f:\rsite{D}{S}{U} \rightarrow \rsite{C}{T}{O}$ be a morphism of ringed sites.
Suppose $f^{\#}: \direct{f}\sheaf{O} \rightarrow \sheaf{U}$ is an isomorphism.
