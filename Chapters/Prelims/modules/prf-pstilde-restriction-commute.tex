\begin{lemma}[$\pstilde$ commutes with restriction]\label[lemma]{7cd}
Let $\rsite{C}{T}{O}$ be a ringed site.
Let $a \in \cat{C}$ 
and $u:\overcat{C}{a} \rightarrow \cat{C}$ the forgetful functor.
We have a natural isomorphism 
$t:\direct{u} \circ \pstilde \Rightarrow \pstilde_a \circ (\blank \tensor_{\sect{1}{O}} \sections{a}{O})$.
\end{lemma}
