...
\begin{corollary}\label[corollary]{8d7}
Consider the adjunction $\mainadjunction$.
For quasi-coherent sheaf $\sheaf{F}$ the counit $\counit_{\sheaf{F}}: \stilde{M} \rightarrow \sheaf{F}$ is an isomorphism.
\end{corollary}