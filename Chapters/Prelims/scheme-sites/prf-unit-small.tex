...
As stated in \Cref{966}, we may use results from \cite[\href{http://stacks.math.columbia.edu/tag/01BH}{Tag 01BH}]{stacks} in this setting.
...
\begin{corollary}\label[corollary]{b0c}
Let $X$ be a scheme.
...
\begin{remark}\label[remark]{b14}
Let us be in the situation of \Cref{da6}.
...
\begin{corollary}\label[corollary]{b1b}
