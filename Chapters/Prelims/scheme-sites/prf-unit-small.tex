...
As stated in \Cref{7a7}, we may use results from \cite[Tag 01BH]{stacks} in this setting.
...
\begin{corollary}\label[corollary]{8f9}
Let $X$ be a scheme.
...
\begin{corollary}\label[corollary]{901}
