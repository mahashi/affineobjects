\begin{definition}[Support]\label[definition]{8d9}
Let $\rspace{X}{O}$ be a locally ringed space.
The support of a global section is
\[D_X(a) = \{x\in X \st a\not\in \ker(x)\}.\]
\end{definition}

\begin{definition}[Support of module]\label[definition]{8df}
Let $\rspace{X}{O}$ be a locally ringed space.
...
\begin{definition}[Set cut out by ideal]\label[definition]{8e6}
