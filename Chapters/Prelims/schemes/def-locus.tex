\begin{definition}[Support]\label[definition]{supportsection}
Let $\rspace{X}{O}$ be a locally ringed space.
The support of a global section is
\[D_X(a) = \{x\in X \st a\not\in \ker(x)\}.\]
\end{definition}

\begin{definition}[Support of module]\label[definition]{supportmodule}
Let $\rspace{X}{O}$ be a locally ringed space.
...
\begin{definition}[Set cut out by ideal]\label[definition]{Set cut out by ideal}
