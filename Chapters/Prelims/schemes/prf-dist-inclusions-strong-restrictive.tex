...
By \Cref{tildeqc} we have $\restr{\Spec{S}}{\sheaf{F}} = \widetilde{M}$
for some $R$-module $M$.
...
Hence $\restr{\Spec{S}}{F} = \widetilde{\sect{\Spec{S}}{F}}$.
By \Cref{tildeqc} this implies that $\sheaf{F}$ is quasi-coherent.
\end{proof}