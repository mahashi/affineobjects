...
\begin{definition}[Presheaves]\label[definition]{582}
...
%%%%%%%%%%%%%%%%%  Section functors
\begin{definition}[Sections functor]\label[definition]{58c}
...
\begin{example}\label[example]{59b}
...
\begin{lemma}[Complete]\label[lemma]{5a1}
...
\begin{lemma}[Abelian/Grothendieck]\label[lemma]{5a9}
...
\begin{remark}\label[remark]{5bf}
So $\presheaves{C}$ is a Grothendieck category.
\end{remark}

%%%%%%%%%%%%%%%%% Direct image/ Inverse image
\begin{definition}[direct image]\label[definition]{5c4}
...
\begin{lemma}[direct image commutes with limits]\label[lemma]{5ca}
...
\begin{definition}[Inverse image, direct image \& push-forward]\label[definition]{5d4}
...
\begin{definition}\label[definition]{5e3}
...
\begin{definition}[Internal Hom]\label[definition]{5f7}
...
\begin{definition}[Monoidal structure]\label[definition]{606}
...
\begin{lemma}[Adjunction/monoidal closed structure]\label[lemma]{60b}
