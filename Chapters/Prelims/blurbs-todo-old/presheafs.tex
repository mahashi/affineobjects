...
\begin{definition}[Presheaves]\label[definition]{7bd}
...
%%%%%%%%%%%%%%%%%  Section functors
\begin{definition}[Sections functor]\label[definition]{7c7}
...
\begin{example}\label[example]{7d6}
...
\begin{lemma}[Complete]\label[lemma]{7dc}
...
\begin{lemma}[Abelian/Grothendieck]\label[lemma]{7e4}
...
\begin{remark}\label[remark]{7fa}
So $\presheaves{C}$ is a Grothendieck category.
\end{remark}

%%%%%%%%%%%%%%%%% Direct image/ Inverse image
\begin{definition}[direct image]\label[definition]{7ff}
...
\begin{lemma}[direct image commutes with limits]\label[lemma]{805}
...
\begin{definition}[Inverse image, direct image \& push-forward]\label[definition]{80f}
...
\begin{definition}\label[definition]{81e}
...
\begin{definition}[Internal Hom]\label[definition]{832}
...
\begin{definition}[Monoidal structure]\label[definition]{841}
...
\begin{lemma}[Adjunction/monoidal closed structure]\label[lemma]{846}
