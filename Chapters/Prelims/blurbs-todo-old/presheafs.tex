...
\begin{definition}[Presheaves]\label[definition]{598}
...
%%%%%%%%%%%%%%%%%  Section functors
\begin{definition}[Sections functor]\label[definition]{5a2}
...
\begin{example}\label[example]{5b1}
...
\begin{lemma}[Complete]\label[lemma]{5b7}
...
\begin{lemma}[Abelian/Grothendieck]\label[lemma]{5bf}
...
\begin{remark}\label[remark]{5d5}
So $\presheaves{C}$ is a Grothendieck category.
\end{remark}

%%%%%%%%%%%%%%%%% Direct image/ Inverse image
\begin{definition}[direct image]\label[definition]{5da}
...
\begin{lemma}[direct image commutes with limits]\label[lemma]{5e0}
...
\begin{definition}[Inverse image, direct image \& push-forward]\label[definition]{5ea}
...
\begin{definition}\label[definition]{5f9}
...
\begin{definition}[Internal Hom]\label[definition]{60d}
...
\begin{definition}[Monoidal structure]\label[definition]{61c}
...
\begin{lemma}[Adjunction/monoidal closed structure]\label[lemma]{621}
