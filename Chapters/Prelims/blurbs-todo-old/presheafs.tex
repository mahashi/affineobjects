...
\begin{lemma}[Abelian/Grothendieck]
...
\begin{lemma}[direct image commutes with limits]
...
\begin{definition}[Inverse image, direct image \& push-forward]
...
\begin{lemma}[Adjunction/monoidal closed structure]
