...
\begin{definition}[Presheaves]\label[definition]{581}
...
%%%%%%%%%%%%%%%%%  Section functors
\begin{definition}[Sections functor]\label[definition]{58b}
...
\begin{example}\label[example]{59a}
...
\begin{lemma}[Complete]\label[lemma]{5a0}
...
\begin{lemma}[Abelian/Grothendieck]\label[lemma]{5a8}
...
\begin{remark}\label[remark]{5be}
So $\presheaves{C}$ is a Grothendieck category.
\end{remark}

%%%%%%%%%%%%%%%%% Direct image/ Inverse image
\begin{definition}[direct image]\label[definition]{5c3}
...
\begin{lemma}[direct image commutes with limits]\label[lemma]{5c9}
...
\begin{definition}[Inverse image, direct image \& push-forward]\label[definition]{5d3}
...
\begin{definition}\label[definition]{5e2}
...
\begin{definition}[Internal Hom]\label[definition]{5f6}
...
\begin{definition}[Monoidal structure]\label[definition]{605}
...
\begin{lemma}[Adjunction/monoidal closed structure]\label[lemma]{60a}
