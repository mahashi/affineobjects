...
\begin{definition}[Presheaves]\label[definition]{601}
...
%%%%%%%%%%%%%%%%%  Section functors
\begin{definition}[Sections functor]\label[definition]{60b}
...
\begin{example}\label[example]{61a}
...
\begin{lemma}[Complete]\label[lemma]{620}
...
\begin{lemma}[Abelian/Grothendieck]\label[lemma]{628}
...
\begin{remark}\label[remark]{63e}
So $\presheaves{C}$ is a Grothendieck category.
\end{remark}

%%%%%%%%%%%%%%%%% Direct image/ Inverse image
\begin{definition}[direct image]\label[definition]{643}
...
\begin{lemma}[direct image commutes with limits]\label[lemma]{649}
...
\begin{definition}[Inverse image, direct image \& push-forward]\label[definition]{653}
...
\begin{definition}\label[definition]{662}
...
\begin{definition}[Internal Hom]\label[definition]{676}
...
\begin{definition}[Monoidal structure]\label[definition]{685}
...
\begin{lemma}[Adjunction/monoidal closed structure]\label[lemma]{68a}
