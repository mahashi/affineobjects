...
\begin{definition}[Sheaves of sets]\label[definition]{698}
...
\begin{definition}[Sheaves \#2]\label[definition]{6a7}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{6b2}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{6c5}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{6c9}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{6cd}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{6d2}
...
\begin{definition}[Sheafification]\label[definition]{6dd}
...
\begin{theorem}\label[theorem]{6e6}
...
%% Properties
\begin{remark}[Properties]\label[remark]{6ef}
\begin{itemize}
