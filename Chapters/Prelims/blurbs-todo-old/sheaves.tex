...
\begin{definition}[Sheaves of sets]\label[definition]{619}
...
\begin{definition}[Sheaves \#2]\label[definition]{628}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{633}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{646}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{64a}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{64e}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{653}
...
\begin{definition}[Sheafification]\label[definition]{65e}
...
\begin{theorem}\label[theorem]{667}
...
%% Properties
\begin{remark}[Properties]\label[remark]{670}
\begin{itemize}
