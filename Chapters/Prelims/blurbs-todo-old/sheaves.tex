...
\begin{definition}[Sheaves of sets]\label[definition]{888}
...
\begin{definition}[Sheaves \#2]\label[definition]{897}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{8a2}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{8b5}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{8b9}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{8bd}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{8c2}
...
\begin{definition}[Sheafification]\label[definition]{8cd}
...
\begin{theorem}\label[theorem]{8d6}
...
%% Properties
\begin{remark}[Properties]\label[remark]{8df}
\begin{itemize}
