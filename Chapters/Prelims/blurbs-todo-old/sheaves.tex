...
\begin{definition}[Sheaves of sets]\label[definition]{6e6}
...
\begin{definition}[Sheaves \#2]\label[definition]{6f5}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{700}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{713}
...
\begin{lemma}\label[lemma]{71b}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{720}
...
\begin{definition}[Sheafification]\label[definition]{72b}
...
\begin{theorem}\label[theorem]{734}
...
%% Properties
\begin{remark}[Properties]\label[remark]{73d}
\begin{itemize}
