...
\begin{definition}[Sheaves of sets]\label[definition]{89a}
...
\begin{definition}[Sheaves \#2]\label[definition]{8a9}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{8b4}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{8c7}
%: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{8cb}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{8cf}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{8d4}
...
\begin{definition}[Sheafification]\label[definition]{8df}
...
\begin{theorem}\label[theorem]{8e8}
...
%% Properties
\begin{remark}[Properties]\label[remark]{8f1}
\begin{itemize}
