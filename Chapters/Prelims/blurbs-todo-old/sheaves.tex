...
\begin{definition}[Sheaves of sets]\label[definition]{618}
...
\begin{definition}[Sheaves \#2]\label[definition]{627}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{632}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{645}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{649}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{64d}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{652}
...
\begin{definition}[Sheafification]\label[definition]{65d}
...
\begin{theorem}\label[theorem]{666}
...
%% Properties
\begin{remark}[Properties]\label[remark]{66f}
\begin{itemize}
