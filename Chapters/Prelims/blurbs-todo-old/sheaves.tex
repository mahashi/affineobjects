...
\begin{definition}[Sheaves of sets]\label[definition]{62f}
...
\begin{definition}[Sheaves \#2]\label[definition]{63e}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{649}
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{65c}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{660}
$\plus{F}$ is separated
\end{lemma}

\begin{lemma}\label[lemma]{664}
If $\presheaf{F}$ is separated then $\plus{F}$ is a sheaf.
\end{lemma}


\begin{lemma} \label[lemma]{669}
...
\begin{definition}[Sheafification]\label[definition]{674}
...
\begin{theorem}\label[theorem]{67d}
...
%% Properties
\begin{remark}[Properties]\label[remark]{686}
\begin{itemize}
