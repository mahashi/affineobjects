...
\begin{definition}[Sheaves of sets]\label[definition]{Sheaves of sets}
...
\begin{definition}[Sheaves \#2]\label[definition]{6de}
...
\begin{definition}[Plus construction Shapiro]\label[definition]{Plus construction Shapiro}
Let $(\cat{C},\topo{T})$ be a site. 
...
\begin{definition}[Plus construction Moerdijk]\label[definition]{Plus construction Moerdijk}
%TODO: fill in moerdijks construction
\end{definition}

\begin{lemma}\label[lemma]{700}
$\plus{F}$ is separated
\end{lemma}
...
\begin{definition}[Sheafification]\label[definition]{Sheafification}
Define $\sheafify{F}=\plus{\plus{F}}: \presheaves{C} \rightarrow \sheaves{C}$.
This is a left adjoint to the inclusion functor $\sheaves{C} \rightarrow \presheaves{C}$.

The functor $\sheafify$ commutes with finite limits.
There are two different proofs: Moerdijk and stacks+Shapiro. 
Shapiro defines the plus with as a colimit over a directed set, hence this commutes with limits.
\end{definition}

\begin{theorem}\label[theorem]{71d}
...
%% Properties
\begin{remark}[Properties]\label[remark]{Properties}
\begin{itemize}
