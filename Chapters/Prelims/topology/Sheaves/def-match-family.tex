\begin{definition}[Matching family]\label[definition]{d36}
...
% \begin{definition}[Matching family/Morphisms]\label[definition]{d43}
% Let $\cat{C}$ be a category.
% Let $\presheaf{F}$ be a presheaf on on $\cat{C}$.
% Let $a \in \cat{C}$ be an object.
% Let $\sieve{R}$ be a sieve on $a$.
...
\begin{definition}[Amalgamation]\label[definition]{d53}
...
% \begin{definition}[Separated presheaf]\label[definition]{d5d}
