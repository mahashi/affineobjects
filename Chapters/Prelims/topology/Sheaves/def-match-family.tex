\begin{definition}[Matching family]\label[definition]{b38}
...
% \begin{definition}[Matching family/Morphisms]\label[definition]{b45}
% Let $\cat{C}$ be a category.
% Let $\presheaf{F}$ be a presheaf on on $\cat{C}$.
% Let $a \in \cat{C}$ be an object.
% Let $\sieve{R}$ be a sieve on $a$.
...
\begin{definition}[Amalgamation]\label[definition]{b55}
...
% \begin{definition}[Separated presheaf]\label[definition]{b5f}
