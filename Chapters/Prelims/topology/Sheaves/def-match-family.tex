\begin{definition}[Matching family]\label[definition]{a9b}
...
% \begin{definition}[Matching family/Morphisms]\label[definition]{aa8}
% Let $\cat{C}$ be a category.
% Let $\presheaf{F}$ be a presheaf on on $\cat{C}$.
% Let $a \in \cat{C}$ be an object.
% Let $\sieve{R}$ be a sieve on $a$.
...
\begin{definition}[Amalgamation]\label[definition]{ab8}
...
% \begin{definition}[Separated presheaf]\label[definition]{ac2}
