...
\newcommand\LocRingSpaces{\textbf{LRSpaces}}

\newcommand{\union}{\bigcup}
\newcommand{\opUnion}{\cup}
\newcommand{\match}[2]{\mbox{Match}(#1,#2)}
\newcommand\matchfam[3]{({#1}_{#2})_{{#2}\in {#3}}}
...
\newcommand{\mainadjunction}{\adjunction{\globalsections{\blank}}{\stilde{\blank}}}

%\newcommand{\stilde}[1]{\Lambda(#1)}
\DeclareDocumentCommand{\stilde}{ g }{%
 \IfNoValueTF{#1}%
          {\Lambda}%
          {\Lambda(#1)}%
}
\DeclareDocumentCommand{\pstilde}{ g }{%
 \IfNoValueTF{#1}%
          {\lambda}%
          {\lambda(#1)}%
}
...
\DeclareDocumentCommand{\colim}{ m m }{%
%First argument is category, second is the functor
 % \IfNoValueTF{#2}%
 %          {\underset{#1}{colim}}%
 %          {\underset{#1}{colim}}%
 \underset{#1}{colim } #2 %
